...
const aprobar = () => { if (confirm('¿Aprobar el pedido y generar la venta?')) router.post(route('pedidos.aprobar', props.pedido.id)); };
const despachar = () => { if (confirm('¿Despachar el pedido? Se descontará el stock.')) router.post(route('pedidos.despachar', props.pedido.id)); };
const rechazar = () => {
            ...
            <div class="card-body d-flex justify-content-between align-items-start flex-wrap gap-2">
                ...
                <div class="d-flex flex-column gap-2" style="min-width:260px">
                    <template v-if="pedido.estado === 'SOLICITADO'">
                        <button class="btn btn-success" @click="aprobar"><i class="bi bi-check-lg me-1"></i>Aprobar y generar venta</button>
                    ...
                    <button v-if="pedido.estado === 'APROBADO'" class="btn btn-primary" @click="despachar"><i class="bi bi-truck me-1"></i>Despachar</button>
