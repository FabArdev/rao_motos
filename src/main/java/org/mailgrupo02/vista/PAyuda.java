    ...
    public static String generarHtml() {
        ...
        c.append(seccion("&#128681; Generales", new String[][]{
            {"HELP",
             ...
             "HELP"},
            {"WHOAMI",
             "Muestra tu perfil registrado: ID, nombre, correo, rol y datos de contacto.",
             "WHOAMI"},
        }));
        ...
        c.append(seccion("CU1 &bull; &#128101; Gesti&oacute;n de Usuarios", new String[][]{
            ...
            {"GETUSUARIO[id]",
             ...
             "GETUSUARIO[6]"},
            {"CREATEUSUARIO[nombre,correo,pass,rol,telefono,direccion]",
            ...
            {"UPDATEUSUARIO[id,nombre,correo,pass,rol,tel,dir,activo]",
            ...
            {"ACTUALIZARPERFIL[nombre,pass,telefono,direccion]",
             ...
             + "Identificaci&oacute;n autom&aacute;tica por correo.",
        ...
        c.append(seccion("CU4 &bull; &#128221; Gesti&oacute;n de Pedidos", new String[][]{
            ...
            {"ANULARPEDIDO[id]",
             ...
             "ANULARPEDIDO[2]"},
            {"MISPEDIDOS",
             "Lista los pedidos del remitente. Identificaci&oacute;n autom&aacute;tica por correo.",
             "MISPEDIDOS"},
            {"MIPEDIDO[id]",
