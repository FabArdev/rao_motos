...
return [
    ...
    */
    ...
    | de posición de atributo con algo más amigable para el lector,
    | como "Dirección de Correo Electrónico" en lugar de "email".
    |
    */
    ...
    'attributes' => [
        ...
        'precio_venta_base' => 'precio minorista',
        'precio_mayorista' => 'precio mayorista',
        'cantidad_minima_mayorista' => 'cantidad mínima para mayoreo',
        'stock_minimo' => 'stock mínimo',
        'foto' => 'foto',
        'activo' => 'activo',
        'cliente_id' => 'cliente',
        'moto_id' => 'moto',
        'nueva_moto.placa' => 'placa',
        'nueva_moto.marca' => 'marca de la moto',
        'nueva_moto.modelo' => 'modelo de la moto',
        'nueva_moto.anio' => 'año',
